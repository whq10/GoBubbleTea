...
exports.css = function (req, res) {
    if (req.url.indexOf('css') !== -1) {
        const css = fs.createReadStream('/code/go' + req.url, 'utf8');
        css.pipe(res);
    }
...
exports.fonts = function (req, res) {
    if (req.url.indexOf('fonts') !== -1) {
        const fonts = fs.createReadStream('/code/go' + req.url, 'utf8');
        fonts.pipe(res);
    }
...
exports.js = function (req, res) {
    if (req.url.indexOf('js') !== -1) {
        const js = fs.createReadStream('/code/go' + req.url, 'utf8');
        js.pipe(res);
    }
...
exports.images = function (req, res) {
    if (req.url.indexOf('images') !== -1) {
        const images = fs.createReadStream('/code/go' + req.url, 'utf8');
        images.pipe(res);
